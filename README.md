...
2026-05-29 编号 1 主题归档：自动生成的飞书纪要 GitHub Pages 页面。

English summary: 2026-05-29 topic 1 archive, an auto-generated Feishu Minutes GitHub Pages site.

### Online Entry Points

- GitHub repository: https://github.com/siuserxiaowei/2026-05-29-1-obcnv7p1
- Live / GitHub Pages: https://siuserxiaowei.github.io/2026-05-29-1-obcnv7p1/
- Default branch: `main`
...
```bash
git clone https://github.com/siuserxiaowei/2026-05-29-1-obcnv7p1.git
cd 2026-05-29-1-obcnv7p1
```
...
- 妙记：https://vi8r050ecuz.feishu.cn/minutes/obcnv7p1195yll6mtgk38q71
- 模板：wiki
- 页面：`docs/index.html`
